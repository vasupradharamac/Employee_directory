    ...
    render: function () {
        return (
            <div className="bar bar-standard bar-header-secondary">
                <input type="search" placeholder="Type in the employee name here... (why not start with 'James'?)" ref="searchKey" onChange={this.searchHandler} value={this.props.searchKey}/>
            </div>
